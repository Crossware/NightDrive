...
public class ModerateCar : MonoBehaviour, Car
{
    ...
    public ModerateCar(Vector3 spawnPosition, float despawnPosition, float speed){
        this.Position = spawnPosition;
        this.DespawnPosititon = despawnPosition;
        this.Speed = speed;
    }

    public ModerateCar(GameObject car, Vector3 spawnPosition, float despawnPosition, float speed){
        this.Position = spawnPosition;
        this.DespawnPosititon = despawnPosition;
        this.Speed = speed;
        this.carObject = car;
